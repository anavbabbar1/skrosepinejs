...
const hintsCss =
  "font-size: 13pt; font-family: 'JetBrainsMonoNL Nerd Font', monospace; border: 0px; color: #e0def4 !important; background: #232136; background-color: #232136";
...
settings.theme = `
  ...
  kbd {
    ...
    display: inline-block;
    padding: 3px 5px;
    font: 11px 'JetBrainsMonoNL Nerd Font', monospace;
    line-height: 10px;
    vertical-align: middle;
